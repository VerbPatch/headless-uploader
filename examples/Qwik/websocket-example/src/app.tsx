...
export const App = component$(() => {
  ...
  return (
    <div>
      <header>
        <h1>Qwik Uploader - WEBSOCKET example</h1>
        <p>
          Real-time streaming using the <strong>WebSocket protocol</strong> in Qwik.
        </p>
      </header>
      ...
      <section>
        ...
        <div
          ...
          style={{
            ...
            borderRadius: '8px',
            cursor: 'pointer',
            background: isDragOver.value ? '#f3e5f5' : '#f9f9f9',
            borderColor: isDragOver.value ? '#9c27b0' : '#ccc',
            transition: 'all 0.2s',
          }}
        >

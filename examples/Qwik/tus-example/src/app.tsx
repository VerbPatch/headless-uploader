...
export const App = component$(() => {
  ...
  const uploader = useUploader({
    ...
    onBeforeRequest: $(async (file: UploadFile, chunk?: ChunkInfo) => {
      ...
      console.log(
        `[Auth] Preparing TUS request for ${file.metadata.name}${chunk ? ` (Chunk ${chunk.index})` : ''}`,
      );
      return {
        headers: {
  ...
  return (
    <div>
      <header>
        <h1>Qwik Uploader - TUS example</h1>
        <p>
          Resumable uploads using the <strong>TUS protocol</strong> in Qwik.
        </p>
      </header>
      ...
      <section>
        ...
        <div
          ...
          style={{
            ...
            borderRadius: '8px',
            cursor: 'pointer',
            background: isDragOver.value ? '#e8f5e9' : '#f9f9f9',

<script>
  import { useUploader, formatBytes, formatTime, safeBase64 } from '@verbpatch/svelte-uploader';
  ...
  const uploader = useUploader({
    ...
    onBeforeUpload: (file) => {
      ...
      file.metadata.filename_b64 = safeBase64(file.metadata.name);
    },
...
<header>
  <h1>Svelte Uploader - TUS example</h1>
  <p>
    This example demonstrates the <strong>resumable</strong> nature of the library in Svelte using TUS
    Protocol.
  </p>
</header>

...
const stats = computed(() => {
  ...
  return {
    ...
    queued: state.queuedFiles.length,
  };
});
...
<template>
  <div v-if="uploader.state" id="app">
    <header>
      <h1>Vue Uploader - HTTP example</h1>
      <p>
        This example demonstrates the <strong>headless</strong> nature of the library. No built-in
        UI components are used; the logic is completely decoupled from the rendering.
      </p>
    </header>

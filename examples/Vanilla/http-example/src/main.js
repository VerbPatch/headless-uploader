...
document.querySelector('#app').innerHTML = `
  <header>
    <h1>Vanilla Uploader - HTTP example</h1>
    <p>This example demonstrates the <strong>headless</strong> nature of the library. No built-in UI components are used; the logic is completely decoupled from the rendering.</p>
  </header>
